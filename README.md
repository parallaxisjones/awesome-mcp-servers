...
- <img src="https://cdn.simpleicons.org/rust/000000" height="14"/> [Context Harness](https://github.com/parallax-labs/context-harness) - Local-first context ingestion and retrieval for AI tools. Ingest files, Git, S3, and Lua scripts into SQLite with optional embeddings; expose via MCP server for Cursor and Claude.
